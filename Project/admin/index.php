...
$statement = $pdo->prepare("SELECT *  From tbl_product Where expiry BETWEEN '" . $StartDate . "' AND  '" . $EndDate . "' ");
$statement->execute();
$CountTotal = $statement->rowCount();
...
function_alert("Total Expiry Product In This Month is : " .$CountTotal);
